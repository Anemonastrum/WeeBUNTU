...
var Player = GObject.registerClass(
    class Player extends PanelMenu.Button {
        ...
        initWidgets() {
            ...
            this.buttonPrev.connect("touch-event", (w, event) => {
            ...
            this.buttonPlayPause.connect("touch-event", (w, event) => {
                if (event.type() === Clutter.EventType.TOUCH_END)
            ...
            this.buttonNext.connect("touch-event", (w, event) => {
                if (event.type() === Clutter.EventType.TOUCH_END)
            ...
            this.buttonMenu.connect("touch-event", (w, event) => {
                if (event.type() === Clutter.EventType.TOUCH_END)
        ...
        get name() {
            ...
            return (
                (this._otherProxy && this._otherProxy.Identity) ||
                this._strippedName
            );
        }
